        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 mb-12">
            <form method="POST" action="{{ route('kategori.update', $kategori->id) }}">
                ...
                <label class="block text-sm">
                    ...
                    <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="kategori" placeholder="Nama Kategori" value="{{ $kategori->kategori }}" />
                </label>
